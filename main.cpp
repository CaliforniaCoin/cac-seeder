...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Californiacoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.thecaliforniacoin.net", ""};
static const string testnet_seeds[] = {"testnet-seed.thecaliforniacoin.net", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 10169), true);
  }
  do {
